...
const Favourite = (props) => {
  return (
    <svg className="star" onClick={props.handleFavourite} width="164px" height="157px" viewBox="0 0 164 157" version="1.1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink">
      <g id="Page-1" stroke="none" strokeWidth="10" fill={props.isFavourite ? '#FF9001' : 'none'} fillRule="evenodd">
